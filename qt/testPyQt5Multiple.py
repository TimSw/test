...
class Window(QMainWindow):
    ...
    def InitUI(self):
        ...
        buttonWindow1 = QPushButton('TemperatureWindow', self)
        buttonWindow1.move(100, 100)
        buttonWindow1.clicked.connect(self.buttonWindow1_onClick)
        self.lineEdit1 = QLineEdit("Type here what you want to transfer for [TemperatureWindow].", self)
        self.lineEdit1.setGeometry(250, 100, 400, 30)

        buttonWindow2 = QPushButton('LightWindow', self)
        buttonWindow2.move(100, 200)
        buttonWindow2.clicked.connect(self.buttonWindow2_onClick)
        self.lineEdit2 = QLineEdit("Type here what you want to transfer for [LightWindow].", self)
...
class Window1(QDialog):
    def __init__(self, value, parent=None):
        ...
        self.setWindowTitle('TemperatureWindow')
...
class Window2(QDialog):
    def __init__(self, value, parent=None):
        super().__init__(parent)
        self.setWindowTitle('LightWindow')
        self.setWindowIcon(self.style().standardIcon(QStyle.SP_FileDialogInfoView))
